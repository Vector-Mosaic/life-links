import type { CanonicalLifeLinksSnapshot, LegacyLifeLinksSnapshot, LinkBodyDoc } from "./index.js";
...
} satisfies LegacyLifeLinksSnapshot;

// This literal is the reviewed oracle for recursive SQL migration verification. It is
// intentionally independent of mapLegacyLifeLinksSnapshot.
export const EXPECTED_REPRESENTATIVE_CANONICAL_LIFE_LINKS_SNAPSHOT = {
  ...
  projectCompatibility: [
    { projectId: "project-home", lifeLinkId: "project-home" },
    { projectId: "project-other-owner", lifeLinkId: "project-other-owner" },
    { projectId: "project-studio", lifeLinkId: "project-studio" }
  ],
  linkMedia: [
    {
      id: "media-camera-photo",
...
} satisfies CanonicalLifeLinksSnapshot;
